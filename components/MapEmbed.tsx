      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-6 text-sm text-gray-600">
          <div className="flex items-center gap-2">
            ...
            <a href="tel:01005001624" className="hover:text-navy transition-colors">01005001624</a>
            <span>|</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:EELNADY@gmail.com" className="hover:text-navy transition-colors">EELNADY@gmail.com</a>
          </div>
        </div>
      </div>
    </section>
